...
var water_tile_atlas = Vector2i(26,13)
var tree_atlas = Vector2i(0,0)
var tree_atlas2 = Vector2i(0,4)
...
func generate_world():
	...
	tile_map.set_cells_terrain_connect(ground_1_layer, sand_arr, 2,0)
	tile_map.set_cells_terrain_connect(ground_1_layer, grass_arr, spring_grass,0)
	#tile_map.set_cells_terrain_connect(cliff_layer,cliff_arr, 3,0)
